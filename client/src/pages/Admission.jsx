...
export default function Admission() {
  ...
  const fetchAdmissionNumber = async () => {
    try {
      ...
      setAdmissionNumber(res.data.admissionNumber || res.data.nextAdmissionNumber || 'ADM-001');
    } catch {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const studentId = studentRes.data._id || studentRes.data.student?._id;
      ...
      if (fileKeys.length > 0 && studentId) {
        ...
        await uploadDocuments(studentId, fd);
      }
